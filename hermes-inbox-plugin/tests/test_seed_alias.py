...
non-destructive to other platforms' aliases, and never clobbers a name the user
has customized. ``conftest.py`` stubs the hermes-agent modules the plugin imports
